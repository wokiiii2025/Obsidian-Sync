...
const translations: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    "settings.telegram.import.desc": "Pending items loaded: {count}. Import queued Telegram messages into local notes, then sync them.",
  ...
  zh: {
    ...
    "settings.telegram.import.desc": "已加载待处理消息：{count} 条。可将 Telegram 队列消息导入本地笔记，再进入同步流程。",
