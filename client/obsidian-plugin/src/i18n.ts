...
const translations: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    "notice.syncCompleteStats": "Sync complete. Uploaded {uploaded}, downloaded {downloaded}, conflicts {conflicts}, plugin files {pluginFiles}.",
    "notice.conflicts": "Zero Knowledge Sync: {count} conflict copy created.",
    "notice.stateRecovered": "Zero Knowledge Sync repaired a damaged local sync state file. Backup: {path}. If many conflicts appear, open Conflict copies and compare before deleting backups.",
    "notice.registered": "Zero Knowledge Sync registered.",
    "notice.loggedIn": "Zero Knowledge Sync logged in.",
    "notice.vaultChangedRelogin": "Vault ID changed. Old device token was cleared; log in again before syncing.",
    ...
    "settings.pluginSync.name": "Sync selected plugin directories",
    "settings.pluginSync.desc": "When enabled, sync all plugin directories except this sync plugin itself and the optional exclusions below. Plugin files are counted separately.",
    "settings.pluginDirectories.name": "Plugin IDs to exclude",
    "settings.pluginDirectories.desc": "Optional. One plugin ID per line, for example dataview or templater-obsidian. Leave empty to sync all plugin directories.",
  ...
  zh: {
    ...
    "notice.syncCompleteStats": "同步完成。上传 {uploaded}，下载 {downloaded}，冲突 {conflicts}，插件目录文件 {pluginFiles}。",
    "notice.conflicts": "Zero Knowledge Sync：已创建 {count} 个冲突副本。",
    "notice.stateRecovered": "Zero Knowledge Sync 已修复损坏的本地同步状态文件。备份：{path}。如果出现较多冲突，请到“冲突副本”中核对后再清理备份。",
    "notice.registered": "Zero Knowledge Sync 注册成功。",
    "notice.loggedIn": "Zero Knowledge Sync 登录成功。",
    "notice.vaultChangedRelogin": "Vault ID 已改变，旧设备令牌已清除；请重新登录后再同步。",
    "notice.prefix": "Zero Knowledge Sync：{message}",
    ...
    "settings.pluginSync.name": "同步指定插件目录",
    "settings.pluginSync.desc": "开启后同步全部插件目录，但本同步插件自身和下方可选排除项除外。插件文件数会单独统计。",
    "settings.pluginDirectories.name": "要排除的插件 ID",
    "settings.pluginDirectories.desc": "可选。每行一个插件 ID，例如 dataview 或 templater-obsidian。留空则同步全部插件目录。",
